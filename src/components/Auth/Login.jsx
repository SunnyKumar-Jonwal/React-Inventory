        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => setFormData({ email: 'admin@inventory.com', password: 'password123' })}
              ...
              <button
                type="button"
                onClick={() => setFormData({ email: 'sales@inventory.com', password: 'password123' })}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
                Sales Demo
              </button>
              <button
                type="button"
                onClick={() => setFormData({ email: 'manager@inventory.com', password: 'password123' })}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
                Manager Demo
              </button>
              <button
                type="button"
                onClick={() => setFormData({ email: 'accountant@inventory.com', password: 'password123' })}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
                Accountant Demo
              </button>
